...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default=ROOT + '/ultralytics/cfg/models/V8/yolov8.yaml', help='model path(s)')
    ...
    parser.add_argument('--name', default='akcmambayolo', help='save to project/name')
